;; Nayori STX Agentic Commerce v4
;; Versioned STX escrow with a 12 Bitcoin-block review window.

;; ============================================
;; Constants
;; ============================================
(define-constant ERR_NOT_OWNER (err u600))
(define-constant ERR_NOT_AUTHORIZED (err u601))
(define-constant ERR_JOB_NOT_FOUND (err u602))
(define-constant ERR_INVALID_STATUS (err u603))
(define-constant ERR_JOB_EXPIRED (err u604))
(define-constant ERR_INVALID_BUDGET (err u605))
(define-constant ERR_NOT_CLIENT (err u607))
(define-constant ERR_NOT_PROVIDER (err u608))
(define-constant ERR_NOT_EVALUATOR (err u609))
(define-constant ERR_ALREADY_FUNDED (err u610))
(define-constant ERR_INVALID_DESCRIPTION (err u612))
(define-constant ERR_INVALID_PARTY (err u613))
(define-constant ERR_ALREADY_RATED (err u614))
(define-constant ERR_INVALID_RATING (err u615))
(define-constant ERR_NOT_EXPIRED (err u616))
(define-constant ERR_REVIEW_WINDOW_CLOSED (err u617))
(define-constant ERR_TIMEOUT_TOO_EARLY (err u618))
(define-constant ERR_REVIEW_DEADLINE_MISSING (err u619))
(define-constant ERR_NO_PENDING_OWNER (err u620))
(define-constant ERR_NOT_PENDING_OWNER (err u621))
(define-constant ERR_INVALID_OWNER (err u622))
(define-constant ERR_REPUTATION_NOT_PENDING (err u623))
