...
exec /usr/bin/env -i \
  ...
  SERVICE_FEE_MAINNET_TREASURY_ENV_PATH="$SERVICE_FEE_MAINNET_TREASURY_ENV_PATH" \
  ...
  CONFIRM_SERVICE_FEE_MAINNET_TREASURY_ENV_PATH="$CONFIRM_SERVICE_FEE_MAINNET_TREASURY_ENV_PATH" \
