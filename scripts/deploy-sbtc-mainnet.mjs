...
if (RETIRED_UNSAFE_SCRIPT) {
  throw new Error(
    "This historical sBTC deployer is permanently retired because it uses permissive post-conditions. Historical bootstrap only: use npm run deploy:bootstrap:legacy-v2:mainnet after reviewing its typed confirmation guard."
  );
}
