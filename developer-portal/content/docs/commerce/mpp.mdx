...
The live challenge identifies `stacks:1`, the canonical mainnet USDCx contract and an `SP...`
recipient. Reject a challenge naming testnet or another token contract.
